...
STATIC_PAGES: list[tuple[str, str, str]] = [
    ...
    ("/armenian-text-to-speech", "weekly", "0.8"),
    ("/armenian-handwriting-worksheets", "monthly", "0.7"),
    ("/armenian-keyboard", "monthly", "0.8"),
...
TRANSLATED_STATIC_PATHS = {
    ...
    "/best-armenian-learning-apps", "/armenian-typing",
    "/armenian-text-to-speech",
    "/armenian-handwriting-worksheets",
    "/armenian-keyboard",
