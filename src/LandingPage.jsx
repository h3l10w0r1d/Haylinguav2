          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            {GOOGLE_CLIENT_ID && (
              <a
                ...
                className="flex h-11 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50"
              >
