          ...
          <div className="flex items-center gap-3 justify-center mb-4">
            {TELEGRAM_BOT_USERNAME && (
              <div className="relative w-14 h-14">
                ...
                {/* Visible icon button — pointer-events:none so clicks pass to iframe */}
                <div style={{ pointerEvents: "none" }} className="absolute inset-0 flex items-center justify-center rounded-2xl bg-[#1a1a2e] border border-white/10 hover:bg-[#252540] transition cursor-pointer">
